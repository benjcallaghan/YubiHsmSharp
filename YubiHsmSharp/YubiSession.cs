...
public sealed class YubiSession : IDisposable
{
    ...
    /// <param name="utf8Label">The label of the object to list (default for all), UTF-8 encoded and null-terminated.</param>
    ...
    /// </summary>
    /// <param name="utf8Label">Label of the key, UTF-8 encoded and null-terminated.</param>
    ...
    /// </summary>
    /// <param name="utf8Label">The label for the wrap key, UTF-8 encoded and null-terminated.</param>
    ...
    /// </summary>
    /// <param name="utf8Label">The label for the public wrap key, UTF-8 encoded and null-terminated.</param>
    ...
    /// </summary>
    /// <param name="utf8label">The label of the authentication key, UTF-8 encoded and null-terminated.</param>
    /// <param name="domains">The domains to which the key belongs.</param>
    ...
    /// </summary>
    /// <param name="utf8Label">The label for the template, UTF-8 encoded and null-terminated.</param>
    ...
    /// </summary>
    /// <param name="utf8Label">The label for the key, UTF-8 encoded and null-terminated.</param>
    ...
    public ObjectId ImportOtpAeadKey(ReadOnlySpan<byte> utf8Label, Domains domains, in Capabilities capabilities,
        uint nonceId, ReadOnlySpan<byte> key, ObjectId keyId = default)
    {
    ...
    public ObjectId GenerateOtpAeadKey(ReadOnlySpan<byte> utf8Label, Domains domains, in Capabilities capabilities,
        Algorithm algorithm, uint nonceId, ObjectId keyId = default)
    {
