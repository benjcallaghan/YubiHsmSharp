...
* [`YubiHsmSharp.BouncyCastle`](./YubiHsmSharp.BouncyCastle/): A compatibility shim that exposes YubiHSM 2 operations through BouncyCastle-defined interfaces.
...
* [`YubiHsmSharp.Examples`](./YubiHsmSharp.Examples/): A deep-dive into YubiHsmSharp with runnable example code.