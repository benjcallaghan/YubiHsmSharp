...
public static class YubiSessionExtensions
{
    extension(YubiSession session)
    {
        ...
        /// <exception cref="ArgumentException">Thrown if the ZMK is not a valid AES-128, AES-192, or AES-256 key.
        ...
        public ushort ImportKeyBlock(TR31KeyBlock keyBlock, ushort zoneMasterKeyId, ReadOnlySpan<byte> utf8Label,
            Domains domains, ushort keyId = 0)
        {
            ...
            return session.ImportAesKey(utf8Label, domains, capabilities, algorithm, clearKey, keyId);
        }
    }
}