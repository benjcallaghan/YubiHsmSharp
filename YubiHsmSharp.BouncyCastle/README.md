...
* `YubiEd25519PrivateKeyParameters` - Contains the Object ID of an asymmetric key. Usable only with `YubiEddsaSigner`.
...
### `ISigner`
* `YubiEddsaSigner` - Signs data using on-device Ed25519.